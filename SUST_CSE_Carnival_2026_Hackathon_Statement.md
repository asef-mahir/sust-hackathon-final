...
In this challenge, "Operations Team" means the people who help agents continue serving customers. This is a general challenge role, not the official organization structure of any provider. A simple example of the hierarchy is: agent or outlet → field or territory officer → area, thana, or district manager → central provider operations team. Actual structures may be different.

Their daily work may include checking agent service status, reviewing low-balance or unusual-activity alerts, contacting agents, arranging support through approved channels, assigning cases, recording updates, and escalating suspicious cases to a risk or compliance team. For a Super Agent, each provider keeps its own operations process, rules, and data boundary. A prototype may show one combined outlet view, but it must not suggest that one provider can control another provider's balance, data, or decisions.
...
* **Provider operations/network coordination team:** Monitor assigned agents, review important alerts, contact the correct agent or field officer, coordinate approved support, and track the case until closure.
...
| **Recommended** | Use AI, APIs, analytics, or data processing as a meaningful part of the product. |
...
| **Optional** | Teams may independently select and implement one or more relevant fraud or anomaly detection scenarios. They are free to define the pattern, evidence, and review workflow, provided it uses simulated or anonymized data, is documented and evaluated, and does not present an anomaly score as proof of fraud. |
...
| **Auditability & ownership** | Important changes, alerts, acknowledgements, escalations, evidence, and resolution actions should be traceable. |
...
| Deliverable | What judges should see |
| :--- | :--- |
| **Working prototype** | A live flow showing multi-provider balances, liquidity or anomaly alert, and how one important case is coordinated or escalated. |
...
* **Illustrative Bangla alert - liquidity pressure:** বর্তমান লেনদেনের ধারা অনুযায়ী বিকেল ৫টা ২০ মিনিটের মধ্যে আপনার নগদ টাকা শেষ হয়ে যেতে পারে। সবচেয়ে বেশি চাপ আসছে বিকাশ ক্যাশ-আউট থেকে। নিরাপদে সেবা চালু রাখতে কমপক্ষে ২০,০০০ টাকা অতিরিক্ত নগদ ব্যবস্থার করার পরামর্শ দেওয়া হচ্ছে।

### Scenario B - Liquidity pressure with unusual activity
The agent's physical cash is falling quickly and one provider shows a sudden rise in repeated or high transactions. The prototype should show both the liquidity risk and the unusual pattern, explain possible normal reasons, and recommend human review before major action.
* **Illustrative Bangla alert - unusual activity requiring review:** গত ১২ মিনিটে স্বাভাবিকের তুলনায় অনেক বেশি ক্যাশ-আউট হয়েছে। কয়েকটি লেনদেনের পরিমাণ প্রায় একই এবং অল্প কয়েকটি অ্যাকাউন্ট থেকে বারবার অনুরোধ এসেছে। এটি ঈদ-পূর্ব স্বাভাবিক চাহিদাও হতে পারে, তবে বড় অঙ্কের নগদ পুনরায় সরবরাহের আগে লেনদেনগুলো পর্যালোচনা করা প্রয়োজন।
...
| :--- | :--- | :--- |
| **Problem understanding and ecosystem relevance** | 15% | Clarity of operational responsibilities, provider boundaries and common assumptions. |
| **Innovation and decision value** | 20% | Quality and originality of liquidity, anomaly and decision-support insight. |
| **Technical implementation and integration quality** | 25% | End-to-end completeness, code quality, component integration, alert routing or case workflow robustness, reliability, and demonstrable engineering depth. |
...
* Use simulated, anonymized, mock, or safe public data only.
